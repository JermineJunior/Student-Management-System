                            ...
                            <div class="inline-block py-2 min-w-full align-middle md:px-6 lg:px-8">
                                <div
                                    ...
                                    <div v-if="teachers.data.length == 0"
                                        class="p-4 mb-4 text-sm text-red-500 rounded-lg" role="alert">
                                        <p class="mx-4 font-bold"> The selected School dosent has any Teachers !!!
                                        </p>
                                    </div>
                                    <table class="divide-y divide-gray-300 lg:min-w-full md:max-w-xl"
