            ...
            <div class="mx-auto max-w-7xl">
                <div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col mt-8">
                        <div
                            class="overflow-x-auto -mx-4 -my-2 sm:-mx-6 lg:-mx-8"
                        >
                            <div
                                class="inline-block py-2 min-w-full align-middle md:px-6 lg:px-8"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            class="m-6 p-4 space-x-2 text-center bg-gray-100"
                                        >
                                            <h3
                                                class="text-xl font-medium mt-4 text-gray-700"
                                            >
                                                Student not found
                                            </h3>
                                            <p class="text-gray-600 mt-2">
                                                The studen you are looking for
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <button
                                                        class="flex items-center px-2 py-px"
                                                    >
                                                        <span
                                                        ...
                                                        >
                                                        <svg
                                                            class="-me-0.5 h-4 w-4 fill-gray-500"
                                                    ...
                                                    >
                                                        <div class="p-4 divide-y">
                                                            <Link
                                                                ...
                                                                "
                                                                class="block px-2 py-1 text-indigo-600 hover:text-indigo-900"
                                                            >
                                                                View
                                                            </Link>
                                                            <button
                                                                ...
                                                                "
                                                                class="text-red-500 px-2 py-1 hover:text-red-700 "
                                                            >
                                                                Delete
                                                            </button>
                                                        </div>
